...
class EditarAuditoria extends Component {
    ...
    handleSubmit(values) {
        this.toggleModal();
        this.props.actualizarAuditoria(this.props.auditoria._id, {
    ...
    render() {
        const auditoria = this.props.auditoria;
        return (
            <div>
                ...
                <Modal isOpen={this.state.isModalOpen} toggle={this.toggleModal}>
                    <ModalHeader toggle={this.toggleModal}>Editar Auditoría</ModalHeader>
                    <ModalBody>
                        <Row>
                        ...
                        <LocalForm onSubmit={(values) => this.handleSubmit(values)}>
                            <Row className="form-group">
                                ...
                                <Col md={12}>
                                    <Control.text model=".nombre_auditoria" id="nombre_auditoria" name="nombre_auditoria" defaultValue={auditoria.nombre} placeholder="Nombre de la Auditoría" className="form-control" validators={{ required }} />
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={9}>
                                    <Control.text model=".nombre_cliente" id="nombre_cliente" placeholder="Nombre" name="nombre_cliente" defaultValue={auditoria.nombre_clientes[0].nombre} className="form-control" validators={{ required }} />
                                ...
                                <Col md={9}>
                                    <Control.text model=".apellido_cliente" id="apellido_cliente" placeholder="Apellido" name="nombre_cliente" defaultValue={auditoria.nombre_clientes[0].apellido} className="form-control" validators={{ required }} />
                            ...
                            <Row className="form-group">
                                <Col>
                                    <Button type="submit" color="info">Editar Auditoría</Button>
                                </Col>
                            </Row>
                        </LocalForm>
                    </ModalBody>
